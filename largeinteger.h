...
extern int Logical_opp_Numbers(char variable1[],char variable2[]);
extern int Logical_opp_Array_Number(char variable1[],int id,char variable2[]);
extern int Logical_opp_Number_Array(char variable1[],char variable2[],int id);
